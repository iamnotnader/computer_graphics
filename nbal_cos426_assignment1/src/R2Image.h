...
class R2Image {
 public:
  ...
  //Helper functions
  R2Pixel resample(int xsrc, int ysrc, int width, double (*filter)(int xsrc, int ysrc, int xdest, int ydest, int width, R2Image& from_image));
  //double gaussian(int xsrc, int ysrc, int xdest, int ydest, int width);
