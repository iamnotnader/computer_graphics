...
////////////////////////////////////////////////////////////
   ...
   static R3Vector calculate_net_force(R3Scene* scene, R3Particle* particle)
   {
      ...
      return grav_force + drag_force + sink_force + spring_force + attractive_force;
   }
...
////////////////////////////////////////////////////////////
   ...
   // Update position for every particle
      ...
      {
         scene->Particle(k)->old_velocity = scene->Particle(k)->velocity;
         scene->Particle(k)->old_position = scene->Particle(k)->position;
      }
